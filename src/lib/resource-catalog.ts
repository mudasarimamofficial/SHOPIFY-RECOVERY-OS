...
export const RESOURCE_CATALOG: ResourceSpec[] = [
  // Catalog
  { key: "products", label: "Products & variants", group: "Catalog", recoverability: "full", scanned: true },
  { key: "collections", label: "Collections (smart + custom)", group: "Catalog", recoverability: "full", scanned: true },
  ...
  { key: "redirects", label: "URL redirects", group: "Content", recoverability: "full", scanned: true },
  { key: "policies", label: "Store policies", group: "Content", recoverability: "full", scanned: true },
  { key: "files", label: "Files (images, video, docs)", group: "Content", recoverability: "full" },

  // Customers & Orders
  { key: "customers", label: "Customers", group: "Customers", recoverability: "full", scanned: true },
  { key: "orders", label: "Orders (historical)", group: "Customers", recoverability: "partial", scanned: true, note: "Shopify does not allow recreating historical orders. Metadata is exported for records." },
  { key: "draft_orders", label: "Draft orders", group: "Customers", recoverability: "partial" },
  { key: "gift_cards", label: "Gift cards", group: "Customers", recoverability: "partial", note: "Metadata only where permitted." },
  ...
  // Metafields
  { key: "metafields", label: "Metafield definitions", group: "Metafields", recoverability: "full" },
  { key: "metaobjects", label: "Metaobjects", group: "Metafields", recoverability: "full" },

  // Commerce config
  { key: "discounts", label: "Discount codes & automatic", group: "Commerce", recoverability: "full" },
  { key: "shipping", label: "Shipping profiles & zones", group: "Commerce", recoverability: "full" },
  { key: "markets", label: "Markets configuration", group: "Commerce", recoverability: "full" },
  { key: "translations", label: "Translations & locales", group: "Commerce", recoverability: "full" },
  { key: "selling_plans", label: "Selling plans", group: "Commerce", recoverability: "full" },

  // Store settings
  { key: "shop", label: "Shop settings & brand", group: "Settings", recoverability: "full", scanned: true },
  { key: "webhooks", label: "Webhooks", group: "Settings", recoverability: "full" },

  // Manual reconnect
  { key: "payments", label: "Payment providers (Shopify Payments, Stripe, PayPal)", group: "External", recoverability: "manual" },
  ...
  { key: "google_analytics", label: "Google Analytics / Merchant Center", group: "External", recoverability: "manual" },
  { key: "email_auth", label: "Email SPF / DKIM / DMARC", group: "External", recoverability: "manual" },
  { key: "third_party_apps", label: "Third-party app subscriptions & data", group: "External", recoverability: "manual" },
];
