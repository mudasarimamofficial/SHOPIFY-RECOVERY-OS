...
Product/Variant grouping must occur seamlessly within the stream reader state loop, yielding a composite product grouping only when the *next* Product ID token is parsed.
